...
def step_reponse(plot_axes, plot_canvas, xlabel, ylabel):
    ...
    volts=[]	# list to store our volt values
    ...
    # the following code is for the simulated reponse plot
    t = []
    for i in range(len(time)):	# create time values for this plot the same length as the measured results
        t.append(2*i)
